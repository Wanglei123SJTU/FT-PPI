...
echo "upworthy_question_readingease_lowdim_pilot_task_start"
hostname
date
git rev-parse --short HEAD

export CONFIG="configs/upworthy_question_readingease_textonly_lowdim_pilot_1p5b.yaml"
...
required = {"delta_QUESTION", "delta_READING_EASE"}
if not path.exists():
...
echo "upworthy_question_readingease_lowdim_pilot_task_done"
