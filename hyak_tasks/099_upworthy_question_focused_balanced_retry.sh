...
TASK_ID="099_upworthy_question_focused_balanced_retry"
...
print("note: EB/winsorized outcome columns are built dynamically by the experiment script")
PY
...
for cfg in "${CONFIGS[@]}"; do
  echo "== RUN FOCUSED QUESTION PILOT RETRY: $cfg =="
  export CONFIG="$cfg"
